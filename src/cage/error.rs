    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            AgeError::AgeBinaryNotFound(details) => {
                ...
                • Or visit: https://github.com/FiloSottile/age/releases",
                    details
                )
            }
            ...
            AgeError::AllTtyMethodsFailed(methods) => {
                write!(
                    f,
                    "All TTY automation methods failed: {}. Check dependencies: expect, util-linux",
                    methods.join(", ")
                )
            }
            ...
            AgeError::PassphraseValidation { reason, guidance } => {
                write!(
                    f,
                    "Passphrase validation failed: {}. Guidance: {}",
                    reason, guidance
                )
            }
            ...
            AgeError::OutputVerificationFailed {
                expected_path,
                verification_type,
            } => {
                write!(
            ...
            AgeError::InjectionAttemptBlocked {
                ...
                write!(
                    f,
                    "Injection attack '{}' blocked. Pattern: {}",
                    attack_type, detected_pattern
                )
            }
            ...
            AgeError::AuditLogFailed { operation, reason } => {
                write!(
                    f,
                    "Audit logging failed for operation '{}': {}",
                    operation, reason
                )
            }
            ...
            AgeError::ConfigurationError {
                ...
                write!(
                    f,
                    "Configuration error: parameter '{}' value '{}': {}",
            ...
            AgeError::InvalidAdapter(adapter_name) => {
                write!(
                    f,
                    "Invalid adapter: '{}'. Available: shell, rage",
                    adapter_name
                )
            }

            AgeError::AdapterInitializationFailed {
                adapter_name,
                reason,
            } => {
                write!(
            ...
            AgeError::BatchOperationFailed {
                ...
                write!(
                    f,
                    "Batch operation '{}' completed with {} successes, {} failures. Failures: {}",
                    operation,
                    successful_count,
                    failed_count,
                    failures.join("; ")
            ...
            AgeError::PermissionDenied {
                ...
                write!(
                    f,
                    "Permission denied for operation '{}' on '{}'. Suggestion: {}",
                    operation,
                    path.display(),
                    suggestion
                )
            ...
            AgeError::RepositoryOperationFailed {
                ...
                write!(
                    f,
                    "Repository operation '{}' failed for {}: {}",
                    operation,
                    repository.display(),
                    reason
                )
